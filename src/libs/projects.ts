...
export function createResourceRequest (type: NodeType, dataVolumeType: VolumeType, dataSourceType: VolumeSourceType, dataSource: string, project: string, peers: string[], properties: any): ResourceRequest {
